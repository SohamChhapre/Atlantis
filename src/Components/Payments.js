...
import PaymentsSkeleton from './Skeletons/PaymentSkeleton';
import {isAuth,LoginRequiredToast} from './Apiconfig.js'

import comming_soon from './../Icons/Icons-Dash/Electricity_coming_soon.jpg'
  ...
  paginationClickable: true, 
    ...
    <p className="desktop-block">We Support Mobile View Only</p>
        ...
        <div className="card  dash-banner" style={{backgroundColor:"",border:"0px",borderRadius:'5px',margin:"0px 5% 0px 5%"}}>
            <img src={comming_soon} onLoad={()=>setLoading(false)} width="100%" height="auto" style={{margin:"16vh 0px",borderRadius:"5px"}}/>
        </div>
