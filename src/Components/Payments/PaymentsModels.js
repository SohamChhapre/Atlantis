...
const ADD1=()=>{
    ...
    <div class="" style={{margin:"0px",width:"100vw",height:"100%"}}>
      <div class="" style={{height:"100%",maxHeight:"100%",overflowY:"scroll"}}>
       ...
       <Link exact to="/payments/2"><button className="btn btn-success" style={{fontSize:"11px",borderRadius:"4px",padding:"4px 24px 4px 24px",fontFamily:"Poppins-Medium",color:"white",marginTop:"30px"}} >Next</button></Link>
        </div>
        </div>
...
const ADD3=()=>{
    ...
    <Link exact to="/payments/2">    <button className="btn " style={{borderRadius:"4px",fontSize:"11px",padding:"4px 24px 4px 24px",fontFamily:"Poppins-Medium",color:"#F49901",background:"white",border:"1px solid #F49901",margin:"30px 50px 0px 0px"}} >Back</button></Link>
        {/* <button className="btn " style={{borderRadius:"4px",fontSize:"11px",padding:"4px 24px 4px 24px",fontFamily:"Poppins-Medium",color:"#F49901",background:"white",border:"1px solid #F49901",margin:"30px 50px 0px 0px"}} >Back</button> */}
      <Link exact to="/payments">  <button className="btn btn-success" style={{fontSize:"11px",borderRadius:"4px",padding:"4px 24px 4px 24px",fontFamily:"Poppins-Medium",color:"white",marginTop:"30px"}}  >Next</button></Link>
        </div>
        </div>
...
const PaymentsModels=(props)=>{
    ...
    var path=props.match.params.id
    ...
    return (
       ...
       <Zoom>
        ...
        {props.match.params.id==1 && <ADD1/>}
        {props.match.params.id==2 && <ADD2/>}
        {props.match.params.id==3 && <ADD3/>}
        </div>
        </Zoom>
  </div>
    )
